<?php
/**
 * The template part for displaying About section
 *
 */
?>

	<section class="section section-homeAbout">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="section-homeAbout-line1"><?php the_field('box_title', 'option'); ?></div>
						<div class="section-homeAbout-desc"><?php the_field('box_text', 'option'); ?></div>
